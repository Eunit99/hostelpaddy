...
var Emitter = function() {
  ...
  function C(e, t) {
    ...
    if (_classCallCheck(this, C),
        (n = _possibleConstructorReturn(this, _getPrototypeOf(C).call(this)))
            .element = e,
        n.version = C.version,
    ...
    if (n.options = C.extend({}, n.defaultOptions, o, null != t ? t : {}),
      ...
      return _possibleConstructorReturn(
          n, n.options.fallback.call(_assertThisInitialized(n)));
    ...
    return n.options.acceptedMimeTypes &&
               ...
               (n.options.renameFile =
                    function(e) {
                      return n.options.renameFilename.call(
                          _assertThisInitialized(n), e.name, e)
                    }),
           ...
           n.options.clickable && (!0 === n.options.clickable
                                       ? n.clickableElements = [ n.element ]
                                       : n.clickableElements = C.getElements(
                                             n.options.clickable, "clickable")),
           n.init(), n
  }
  return _inherits(C, Emitter),
         ...
         this.prototype.defaultOptions = {
           ...
           addedfile : function(t) {
             ...
             if (this.element === this.previewsContainer &&
               ...
               t.previewElement =
                   C.createElement(this.options.previewTemplate.trim()),
               ...
               try {
                 for (var d, p = t.previewElement.querySelectorAll(
               ...
               var h = function(e) {
                 return e.preventDefault(), e.stopPropagation(),
                        t.status === C.UPLOADING
                            ? C.confirm(n.options.dictCancelUploadConfirmation,
                                        function() { return n.removeFile(t) })
                        : n.options.dictRemoveFileConfirmation
                            ? C.confirm(n.options.dictRemoveFileConfirmation,
                                        function() { return n.removeFile(t) })
                            : n.removeFile(t)
               }, f = !0, v = !1, m = void 0;
               try {
         ...
         _createClass(
             ...
             [
               ...
               {
                 key : "getQueuedFiles",
                 value : function() { return this.getFilesWithStatus(C.QUEUED) }
               },
               {
                 key : "getUploadingFiles",
                 value :
                     function() { return this.getFilesWithStatus(C.UPLOADING) }
               },
               {
                 key : "getAddedFiles",
                 value : function() { return this.getFilesWithStatus(C.ADDED) }
               },
               {
                 key : "getActiveFiles",
                 value : function() {
                 ...
                 value : function() {
                   ...
                   if ("form" === this.element.tagName &&
                       ...
                       this.element.classList.contains("dropzone") &&
                           ...
                           this.element.appendChild(C.createElement(
                     ...
                     !function l() {
                       return s.hiddenFileInput &&
                              ...
                              C.getElement(s.options.hiddenInputContainer,
               ...
               },
               {
                 key : "paste",
                 value : function(e) {
                   if (null != __guard__(null != e ? e.clipboardData : void 0,
               ...
               },
               {
                 ...
                 value : function(t) {
                   ...
                   this.files.push(t), t.status = C.ADDED,
                   ...
                   return e && (d.crossOrigin = e), d.onload = function() {
                     ...
                     return "undefined" != typeof EXIF && null !== EXIF && t &&
                            ...
                            e(function(e) {
                              ...
                              drawImageIOSFix(i, d, null != t.srcX ? t.srcX : 0,
                                              null != t.srcY ? t.srcY : 0,
                                              t.srcWidth, t.srcHeight,
                                              null != t.trgX ? t.trgX : 0,
                                              null != t.trgY ? t.trgY : 0,
                                              t.trgWidth, t.trgHeight);
                 ...
                 value : function(e) {
                   ...
                   try {
                     for (var r, o = e[Symbol.iterator]();
                          !(t = (r = o.next()).done); t = !0) {
                       var a = r.value;
                       a.processing = !0, a.status = C.UPLOADING,
                 ...
                 value : function(e) {
                   if (e.status === C.UPLOADING) {
                     ...
                     e.status !== C.ADDED && e.status !== C.QUEUED ||
                         (e.status = C.CANCELED, this.emit("canceled", e),
                          this.options.uploadMultiple &&
                   ...
                   this._transformFiles(s, function(e) {
                     ...
                     if (s[0].upload.chunked) {
                       ...
                       if (r.upload.finishedChunkUpload = function(e) {
                             var t = !0;
                             e.status = C.SUCCESS, e.dataBlock = null,
                             e.xhr = null;
                       ...
                       for (var r, o = this.element.querySelectorAll(
                         ...
                         if (s = s && s.toLowerCase(), null != l)
                           if ("SELECT" === a.tagName &&
                             ...
                             try {
                               for (var p, h = a.options[Symbol.iterator]();
                                    !(u = (p = h.next()).done); u = !0) {
                                 var f = p.value;
                     ...
                     if (i = 100 * n.loaded / n.total, e[0].upload.chunked) {
                       ...
                       try {
                         for (var c, d = e[Symbol.iterator]();
                              !(l = (c = d.next()).done); l = !0) {
                           var p = c.value;
                           p.upload.progress = i, p.upload.total = n.total,
                 ...
                 value : function(e, t, n) {
                   ...
                   try {
                     for (var a, l = e[Symbol.iterator]();
                          !(i = (a = l.next()).done); i = !0) {
                       var s = a.value;
                       s.status = C.SUCCESS, this.emit("success", s, t, n),
                 ...
                 value : function(e, t, n) {
                   ...
                   try {
                     for (var a, l = e[Symbol.iterator]();
                          !(i = (a = l.next()).done); i = !0) {
                       var s = a.value;
                       s.status = C.ERROR, this.emit("error", s, t, n),
                       this.emit("complete", s)
                     }
                   } catch (e) {
                     r = !0, o = e
...
Dropzone.initClass(),
    Dropzone.version = "5.7.0", Dropzone.options = {},
      ...
      if (document.querySelectorAll)
        ...
        var e = function(l) {
          return function() {
            var e = [], t = !0, n = !1, i = void 0;
            try {
              for (var r, o = l[Symbol.iterator](); !(t = (r = o.next()).done);
                   t = !0) {
                var a = r.value;
      ...
      return function() {
        ...
        try {
          for (var r, o = s[Symbol.iterator](); !(t = (r = o.next()).done);
               t = !0) {
            var a = r.value;
            !1 !== Dropzone.optionsForElement(a) ? e.push(new Dropzone(a))
                                                 : e.push(void 0)
          }
        } catch (e) {
          n = !0, i = e
    ...
    Dropzone.isBrowserSupported = function() {
      ...
      if (window.File && window.FileReader && window.FileList && window.Blob &&
        ...
        if ("classList" in document.createElement("a")) {
          var t = !0, n = !1, i = void 0;
          try {
            for (var r, o = Dropzone.blacklistedBrowsers[Symbol.iterator]();
                 !(t = (r = o.next()).done); t = !0) {
...
var without = function(e, t) {
  return e.filter(function(e) { return e !== t }).map(function(e) { return e })
}, camelize = function(e) {
  ...
  return t.innerHTML = e, t.childNodes[0]
    ...
    Dropzone.getElements =
      ...
      if (e instanceof Array) {
        ...
        try {
          for (var p, h = document.querySelectorAll(e)[Symbol.iterator]();
               !(u = (p = h.next()).done); u = !0)
            n = p.value, i.push(n)
        } catch (e) {
          c = !0, d = e
    ...
    "undefined" != typeof jQuery && null !== jQuery &&
        (jQuery.fn.dropzone =
             function(e) {
               return this.each(function() { return new Dropzone(this, e) })
             }),
...
var contentLoaded = function(t, n) {
  ...
  if ("complete" !== o.readyState) {
    ...
    return o[l](u + "DOMContentLoaded", i, !1),
           o[l](u + "readystatechange", i, !1), t[l](u + "load", i, !1)
  }
};
