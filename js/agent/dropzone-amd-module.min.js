!function(e) {
  ...
  function l(e) {
    return (
        l = Object.setPrototypeOf
                ...
                : function(
                      e) { return e.__proto__ || Object.getPrototypeOf(e) })(e)
  }
  function s(e) {
    if (void 0 === e)
  ...
  var c = function() {
                 ...
                 value : function(e) {
                   ...
                   if (t) {
                     for (var n = arguments.length,
                              i = new Array(1 < n ? n - 1 : 0), r = 1;
                          r < n; r++)
                       i[r - 1] = arguments[r];
                     var o = !0, a = !1, l = void 0;
                     try {
                       for (var s, u = t[Symbol.iterator]();
                            !(o = (s = u.next()).done); o = !0) {
    ...
    function z(e, t) {
      var n, i, r;
      if (u(this, z), (n = a(this, l(z).call(this))).element = e,
          n.version = z.version,
          n.defaultOptions.previewTemplate =
              n.defaultOptions.previewTemplate.replace(/\n*/g, ""),
          n.clickableElements = [], n.listeners = [], n.files = [],
      ...
      return n.options.acceptedMimeTypes &&
      ...
      t && i(e, t)
         ...
         this.prototype.defaultOptions = {
           ...
           params : function(e, t, n) {
             if (n)
               return {
                 dzuuid: n.file.upload.uuid, dzchunkindex: n.index,
           ...
           fallback : function() {
             ...
             this.element.className =
                 "".concat(this.element.className, " dz-browser-not-supported");
             var t = !0, n = !1, i = void 0;
             try {
               for (var r, o = this.element.getElementsByTagName(
                               "div")[Symbol.iterator]();
                    !(t = (r = o.next()).done); t = !0) {
                 var a = r.value;
           ...
           resize : function(e, t, n, i) {
             var r = {
               ...
               srcHeight : e.height
                 ...
                 o = e.width / e.height;
             null == t && null == n ? (t = r.srcWidth, n = r.srcHeight)
             : null == t            ? t = n * o
                                    : null == n && (n = t / o);
             var a =
                 (t = Math.min(t, r.srcWidth)) / (n = Math.min(n, r.srcHeight));
             if (r.srcWidth > t || r.srcHeight > n)
               if ("crop" === i)
                 a < o ? (r.srcHeight = e.height, r.srcWidth = r.srcHeight * a)
             ...
             return r.srcX = (e.width - r.srcWidth) / 2,
                    r.srcY = (e.height - r.srcHeight) / 2, r.trgWidth = t,
                    r.trgHeight = n, r
           },
           transformFile : function(e, t) {
             return (this.options.resizeWidth || this.options.resizeHeight) &&
                            e.type.match(/image.*/)
                        ? this.resizeImage(e, this.options.resizeWidth,
           ...
           addedfile : function(t) {
             ...
             if (this.element === this.previewsContainer &&
               ...
               try {
                 for (var d, h = t.previewElement.querySelectorAll(
               ...
               function p(e) {
                 return e.preventDefault(), e.stopPropagation(),
                        t.status === z.UPLOADING
                            ? z.confirm(n.options.dictCancelUploadConfirmation,
                                        function() { return n.removeFile(t) })
                        : n.options.dictRemoveFileConfirmation
                            ? z.confirm(n.options.dictRemoveFileConfirmation,
                                        function() { return n.removeFile(t) })
                            : n.removeFile(t)
               }
               var f = !0, v = !1, m = void 0;
               try {
                 for (var y, g = t.previewElement.querySelectorAll(
                                 "[data-dz-remove]")[Symbol.iterator]();
                      !(f = (y = g.next()).done); f = !0) {
           ...
           thumbnail : function(e, t) {
             if (e.previewElement) {
               ...
               try {
                 for (var o, a = e.previewElement.querySelectorAll(
           ...
           error : function(e, t) {
             if (e.previewElement) {
               ...
               try {
                 for (var o, a = e.previewElement.querySelectorAll(
                                 "[data-dz-errormessage]")[Symbol.iterator]();
                      !(n = (o = a.next()).done); n = !0) {
           ...
           uploadprogress : function(e, t) {
             if (e.previewElement) {
               ...
               try {
                 for (var o, a = e.previewElement.querySelectorAll(
                                 "[data-dz-uploadprogress]")[Symbol.iterator]();
                      !(n = (o = a.next()).done); n = !0) {
                   var l = o.value;
                   "PROGRESS" === l.nodeName ? l.value = t
             ...
             [
               {
                 ...
                 value : function() {
                   return this.files.filter(function(e) { return e.accepted })
               ...
               },
               {
                 ...
                 value : function(t) {
                   return this.files
                       .filter(function(e) { return e.status === t })
                       .map(function(e) { return e })
                 }
               },
               {
                 key : "getQueuedFiles",
                 value : function() { return this.getFilesWithStatus(z.QUEUED) }
               },
               {
                 key : "getUploadingFiles",
                 value :
                     function() { return this.getFilesWithStatus(z.UPLOADING) }
               },
               {
                 key : "getAddedFiles",
                 value : function() { return this.getFilesWithStatus(z.ADDED) }
               },
               {
                 key : "getActiveFiles",
                 value : function() {
                 ...
                 value : function() {
                   ...
                   if ("form" === this.element.tagName &&
                       ...
                       this.element.classList.contains("dropzone") &&
                           ...
                           this.element.appendChild(z.createElement(
                               '<div class="dz-default dz-message"><button class="dz-button" type="button">'
                                   .concat(this.options.dictDefaultMessage,
                                           "</button></div>"))),
                       this.clickableElements.length) {
                     !function l() {
                       return s.hiddenFileInput &&
                              ...
                              z.getElement(s.options.hiddenInputContainer,
                   ...
                   try {
                     for (var i, r = this.events[Symbol.iterator]();
                          !(e = (i = r.next()).done); e = !0) {
                       var o = i.value;
                   ...
                   this.on("uploadprogress",
                           function() { return s.updateTotalUploadProgress() }),
                       this.on(
                           "removedfile",
                           function() { return s.updateTotalUploadProgress() }),
                       this.on("canceled",
                               function(e) { return s.emit("complete", e) }),
                       this.on("complete", function(e) {
                         if (0 === s.getAddedFiles().length &&
                             0 === s.getUploadingFiles().length &&
                             0 === s.getQueuedFiles().length)
                           return setTimeout(
                               function() { return s.emit("queuecomplete") }, 0)
                       });
                   function a(e) {
                     var t;
                     return (t = e).dataTransfer.types &&
                            t.dataTransfer.types.some(function(
                                e) { return "Files" == e }) &&
                   ...
                   return this.listeners = [ {
                            ...
                            events : {
                              dragstart : function(
                                  e) { return s.emit("dragstart", e) },
                              dragenter : function(
                                  e) { return a(e), s.emit("dragenter", e) },
                              dragover : function(e) {
                                var t;
                                try {
                                ...
                                return e.dataTransfer.dropEffect =
                                           "move" === t || "linkMove" === t
                                               ? "move"
                                               : "copy",
                                       a(e), s.emit("dragover", e)
                              },
                              dragleave : function(
                                  e) { return s.emit("dragleave", e) },
                              drop : function(e) { return a(e), s.drop(e) },
                              dragend : function(
                                  e) { return s.emit("dragend", e) }
                            }
                          } ],
               ...
               },
               {
                 ...
                 value : function() {
                   ...
                   if (this.getActiveFiles().length) {
                     ...
                     try {
                       for (var a, l = this.getActiveFiles()[Symbol.iterator]();
                            !(i = (a = l.next()).done); i = !0) {
                         var s = a.value;
                 ...
                 value : function(e) {
                   return "function" == typeof this.options.paramName
                              ...
                              : "".concat(this.options.paramName)
                                    .concat(this.options.uploadMultiple
                                                ? "[".concat(e, "]")
                                                : "")
                 }
               },
               ...
               },
               {
                 ...
                 value : function() {
                   ...
                   this.options.dictFallbackText &&
                       (n +=
                        "<p>".concat(this.options.dictFallbackText, "</p>")),
                       n +=
               ...
               },
               {
                 ...
                 value : function() {
                   ...
                   return this.clickableElements.forEach(function(
                              e) { return e.classList.remove("dz-clickable") }),
                          this.removeEventListeners(),
                          this.disabled = !0,
                          this.files.map(function(
                              e) { return t.cancelUpload(e) })
                 }
               },
               {
                 key : "enable",
                 value : function() {
                   return delete this.disabled,
                          this.clickableElements.forEach(function(
                              e) { return e.classList.add("dz-clickable") }),
               ...
               },
               {
                 ...
                 value : function(e) {
                   var t = 0, n = "b";
                   if (0 < e) {
                     for (var i = [ "tb", "gb", "mb", "kb", "b" ], r = 0;
                          r < i.length; r++) {
                       var o = i[r];
                       if (Math.pow(this.options.filesizeBase, 4 - r) / 10 <=
                           e) {
               ...
               },
               {
                 ...
                 value : function(e) {
                   if (e.dataTransfer) {
                     this.emit("drop", e);
                     for (var t = [], n = 0; n < e.dataTransfer.files.length;
                          n++)
               ...
               },
               {
                 ...
                 value : function(s) {
                   ...
                   return function() {
                     ...
                     try {
                       for (var r, o = s[Symbol.iterator]();
                            !(t = (r = o.next()).done); t = !0) {
                         var a, l = r.value;
                         null != l.webkitGetAsEntry &&
                                 (a = l.webkitGetAsEntry())
                             ? a.isFile ? e.push(u.addFile(l.getAsFile()))
                               : a.isDirectory
               ...
               },
               {
                 ...
                 value : function(e, s) {
                   function t(t) {
                     return e = console, n = "log",
                            i = function(e) { return e.log(t) },
                            null != e && "function" == typeof e[n] ? i(e, n)
                                                                   : void 0;
                     var e, n, i
                   }
                         ...
                         try {
                           for (var r, o = e[Symbol.iterator]();
                             ...
                             a.isFile ? a.file(function(e) {
                               if (!u.options.ignoreHiddenFiles ||
                                   "." !== e.name.substring(0, 1))
                                 return e.fullPath =
                                            "".concat(s, "/").concat(e.name),
                                        u.addFile(e)
                             })
                                      : a.isDirectory &&
                 ...
                 value : function(e, t) {
                   ...
                   : z.isValidFile(e, this.options.acceptedFiles)
                       ? null != this.options.maxFiles &&
                                 this.getAcceptedFiles().length >=
                                     this.options.maxFiles
                             ? (t(this.options.dictMaxFilesExceeded.replace(
               ...
               },
               {
                 ...
                 value : function(t) {
                   ...
                   this.files.push(t), t.status = z.ADDED,
                   this.emit("addedfile", t), this._enqueueThumbnail(t),
                   this.accept(t, function(e) {
                     e ? (t.accepted = !1, n._errorProcessing([ t ], e))
                       : (t.accepted = !0,
               ...
               },
               {
                 ...
                 value : function(e) {
                   ...
                   if (e.status = z.QUEUED, this.options.autoProcessQueue)
                     return setTimeout(function() { return t.processQueue() },
                                       0)
                 }
               },
               {
               ...
               },
               {
                 key : "removeFile",
                 value : function(e) {
                   if (e.status === z.UPLOADING && this.cancelUpload(e),
                       this.files = h(this.files, e),
                       this.emit("removedfile", e), 0 === this.files.length)
               ...
               },
               {
                 ...
                 value : function(e) {
                   ...
                   var t = !0, n = !1, i = void 0;
                   try {
                     for (var r, o = this.files.slice()[Symbol.iterator]();
                          !(t = (r = o.next()).done); t = !0) {
                       var a = r.value;
               ...
               },
               {
                 ...
                 value : function(r, e, t, n, o) {
                   ...
                   return this.createThumbnail(r, e, t, n, !0, function(e, t) {
                     ...
                     return "image/jpeg" !== n && "image/jpg" !== n ||
               ...
               },
               {
                 ...
                 value : function(e, t, n, i, r, o) {
                   ...
                   l.onload = function() {
                     e.dataURL = l.result,
                     "image/svg+xml" !== e.type ? a.createThumbnailFromUrl(
                                                      e, t, n, i, r, o)
                                                : null != o && o(l.result)
                   }, l.readAsDataURL(e)
                 }
                 ...
                 value : function(t, e, n, i, r) {
                   ...
                   if (this.emit("addedfile", t), this.emit("complete", t), a) {
                     ...
                     this.createThumbnailFromUrl(
                         t, this.options.thumbnailWidth,
                         this.options.thumbnailHeight,
                         this.options.resizeMethod, this.options.fixOrientation,
                         function(e) { o.emit("thumbnail", t, e), n && n() }, i)
                   } else
               ...
               },
               {
                 ...
                 value : function(o, a, l, s, t, u, e) {
                   ...
                   return e && (d.crossOrigin = e), d.onload = function() {
                     ...
                     return "undefined" != typeof EXIF && null !== EXIF && t &&
                                (e =
                                     function(e) {
                            ...
                            e(function(e) {
                              ...
                              f(i, d, null != t.srcX ? t.srcX : 0,
                                null != t.srcY ? t.srcY : 0, t.srcWidth,
                                t.srcHeight, null != t.trgX ? t.trgX : 0,
                                null != t.trgY ? t.trgY : 0, t.trgWidth,
                                t.trgHeight);
               ...
               {
                 key : "processFile",
                 value : function(e) { return this.processFiles([ e ]) }
               },
               {
                 key : "processFiles",
                 value : function(e) {
                   ...
                   try {
                     for (var r, o = e[Symbol.iterator]();
                          !(t = (r = o.next()).done); t = !0) {
                       var a = r.value;
                       a.processing = !0, a.status = z.UPLOADING,
               ...
               },
               {
                 ...
                 value : function(t) {
                   return this.files.filter(function(e) { return e.xhr === t })
                       .map(function(e) { return e })
                 }
               },
               {
                 ...
                 value : function(e) {
                   if (e.status === z.UPLOADING) {
                     ...
                     e.status !== z.ADDED && e.status !== z.QUEUED ||
                         (e.status = z.CANCELED, this.emit("canceled", e),
                          this.options.uploadMultiple &&
               ...
               {
                 key : "uploadFile",
                 value : function(e) { return this.uploadFiles([ e ]) }
               },
               {
                 key : "uploadFiles",
                 value : function(s) {
                   ...
                   this._transformFiles(s, function(e) {
                     if (u.options.chunking) {
                       var t = e[0];
                       s[0].upload.chunked =
                           u.options.chunking && (u.options.forceChunking ||
                                                  t.size > u.options.chunkSize),
                       s[0].upload.totalChunkCount =
                           Math.ceil(t.size / u.options.chunkSize)
                     }
                     if (s[0].upload.chunked) {
                         ...
                         if (!(e >= r.upload.totalChunkCount)) {
                           ...
                           var t = e * u.options.chunkSize,
                               ...
                               i = {
                                 ...
                                 data : o.webkitSlice ? o.webkitSlice(t, n)
                                                      : o.slice(t, n),
                       ...
                       if (r.upload.finishedChunkUpload = function(e) {
                             var t = !0;
                             e.status = z.SUCCESS, e.dataBlock = null,
                             e.xhr = null;
                             for (var n = 0; n < r.upload.totalChunkCount;
                                  n++) {
                               if (void 0 === r.upload.chunks[n])
                                 return i();
                               r.upload.chunks[n].status !== z.SUCCESS &&
                                   (t = !1)
                             }
                             t &&
                                 u.options.chunksUploaded(
                                     r, function() { u._finished(s, "", null) })
               ...
               },
               {
                 key : "_uploadData",
                 value : function(t, e) {
                   var n = this, i = new XMLHttpRequest, r = !0, o = !1,
                       a = void 0;
                   try {
                   ...
                   i.open(u, c, !0),
                       ...
                       i.onload = function(e) { n._finishedUploading(t, i, e) },
                       i.ontimeout =
                           function() {
                         n._handleUploadError(
                             t, i,
                             "Request timedout after ".concat(n.options.timeout,
                                                              " seconds"))
                       },
                       i.onerror = function() { n._handleUploadError(t, i) },
                       (null != i.upload ? i.upload : i).onprogress = function(
                           e) { return n._updateFilesUploadProgress(t, i, e) };
                   var d = {
                 ...
                 value : function(n, i) {
                   function e(t) {
                     r.options.transformFile.call(
                         r, n[t],
                         function(e) { o[t] = e, ++a === n.length && i(o) })
                   }
               ...
               },
               {
                 ...
                 value : function(e) {
                   if ("FORM" === this.element.tagName) {
                     var t = !0, n = !1, i = void 0;
                     try {
                       for (var r, o = this.element.querySelectorAll(
                         ...
                         if (s = s && s.toLowerCase(), null != l)
                           if ("SELECT" === a.tagName &&
                             ...
                             try {
                               for (var h, p = a.options[Symbol.iterator]();
                                    !(u = (h = p.next()).done); u = !0) {
                                 var f = h.value;
                 ...
                 value : function(e, t, n) {
                   ...
                   if (void 0 !== n) {
                     if (i = 100 * n.loaded / n.total, e[0].upload.chunked) {
                       ...
                       o.progress = i, o.total = n.total,
                       o.bytesSent = n.loaded;
                       r.upload.progress = 0, r.upload.total = 0;
                       for (var a = r.upload.bytesSent = 0;
                            a < r.upload.totalChunkCount; a++)
                       ...
                       var l = !0, s = !1, u = void 0;
                       try {
                         for (var c, d = e[Symbol.iterator]();
                              !(l = (c = d.next()).done); l = !0) {
                           var h = c.value;
                           h.upload.progress = i, h.upload.total = n.total,
                           h.upload.bytesSent = n.loaded
                         }
                       } catch (e) {
                         s = !0, u = e
                       } finally {
                     ...
                     var p = !0, f = !1, v = void 0;
                     try {
                       for (var m, y = e[Symbol.iterator]();
                            !(p = (m = y.next()).done); p = !0) {
                         var g = m.value;
                         this.emit("uploadprogress", g, g.upload.progress,
                                   g.upload.bytesSent)
                       }
                     } catch (e) {
                       f = !0, v = e
                     ...
                     if (b)
                       return;
                     var z = !0, S = !1, L = void 0;
                     try {
                       for (var _, T = e[Symbol.iterator]();
                            !(z = (_ = T.next()).done); z = !0) {
                         var A = _.value;
                 ...
                 value : function(e, t, n) {
                   if (e[0].status !== z.CANCELED) {
                     ...
                     this._errorProcessing(
                         e,
                         n || this.options.dictResponseError.replace(
                                  "{{statusCode}}", t.status),
                         t)
                   }
                 }
                 ...
                 value : function(e, t, n) {
                   ...
                   try {
                     for (var a, l = e[Symbol.iterator]();
                          !(i = (a = l.next()).done); i = !0) {
                       var s = a.value;
                       s.status = z.SUCCESS, this.emit("success", s, t, n),
                 ...
                 value : function(e, t, n) {
                   ...
                   try {
                     for (var a, l = e[Symbol.iterator]();
                          !(i = (a = l.next()).done); i = !0) {
                       var s = a.value;
                       s.status = z.ERROR, this.emit("error", s, t, n),
                       this.emit("complete", s)
                     }
                   } catch (e) {
                     r = !0, o = e
  ...
  d.initClass(),
      d.version = "5.7.0", d.options = {},
      d.optionsForElement =
          function(e) {
        return e.getAttribute("id") ? d.options[p(e.getAttribute("id"))]
                                    : void 0
      },
      d.instances = [],
      d.forElement =
      ...
      d.discover =
        ...
        if (document.querySelectorAll)
          ...
          function e(l) {
            return function() {
              var e = [], t = !0, n = !1, i = void 0;
              try {
                for (var r, o = l[Symbol.iterator]();
                     !(t = (r = o.next()).done); t = !0) {
                  var a = r.value;
                  /(^| )dropzone($| )/.test(a.className) ? e.push(s.push(a))
                                                         : e.push(void 0)
                }
              } catch (e) {
                n = !0, i = e
        ...
        return function() {
          var e = [], t = !0, n = !1, i = void 0;
          try {
            for (var r, o = s[Symbol.iterator](); !(t = (r = o.next()).done);
                 t = !0) {
              var a = r.value;
      ...
      d.isBrowserSupported = function() {
        ...
        if (window.File && window.FileReader && window.FileList &&
          ...
          if ("classList" in document.createElement("a")) {
            var t = !0, n = !1, i = void 0;
            try {
              for (var r, o = d.blacklistedBrowsers[Symbol.iterator]();
                   !(t = (r = o.next()).done); t = !0) {
        ...
        for (var t = atob(e.split(",")[1]),
                 n = e.split(",")[0].split(":")[1].split(";")[0],
                 i = new ArrayBuffer(t.length), r = new Uint8Array(i), o = 0,
                 a = t.length, l = 0 <= a;
             l ? o <= a : a <= o; l ? o++ : o--)
          r[o] = t.charCodeAt(o);
  ...
  var h = function(e, t) {
    return e.filter(function(e) { return e !== t })
        .map(function(e) { return e })
  }, p = function(e) {
    return e.replace(/[\-_](\w)/g,
                     function(e) { return e.charAt(1).toUpperCase() })
  };
  d.createElement =
      function(e) {
  ...
  d.getElements =
    ...
    if (e instanceof Array) {
      ...
      try {
        ...
        try {
          for (var l, s = e[Symbol.iterator](); !(r = (l = s.next()).done);
               r = !0)
      ...
      try {
        for (var h, p = document.querySelectorAll(e)[Symbol.iterator]();
             !(u = (h = p.next()).done); u = !0)
          n = h.value, i.push(n)
      } catch (e) {
        c = !0, d = e
  ...
  d.confirm = function(
      e, t, n) { return window.confirm(e) ? t()
                        : null != n       ? n()
                                          : void 0 },
  d.isValidFile =
      function(e, t) {
    ...
    try {
      for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done);
           r = !0) {
        var u = l.value;
        if ("." === (u = u.trim()).charAt(0)) {
          if (-1 !== e.name.toLowerCase().indexOf(u.toLowerCase(),
  ...
  null != e &&
      (e.fn.dropzone = function(
           e) { return this.each(function() { return new d(this, e) }) }),
  null != t ? t.exports = d : window.Dropzone = d, d.ADDED = "added",
  d.QUEUED = "queued", d.ACCEPTED = d.QUEUED, d.UPLOADING = "uploading",
  d.PROCESSING = d.UPLOADING, d.CANCELED = "canceled", d.ERROR = "error",
  d.SUCCESS = "success";
  var f = function(e, t, n, i, r, o, a, l, s, u) {
    var c = function(e) {
      ...
      i.drawImage(e, 0, 0);
      for (var r = i.getImageData(1, 0, 1, t).data, o = 0, a = t, l = t;
           o < l;) {
    ...
    return o(e, null,
             [
               ...
               },
               {
                 key : "encode64",
                 value : function(e) {
                   for (var t = "", n = void 0, i = void 0, r = "", o = void 0,
                            a = void 0, l = void 0, s = "", u = 0;
                        o = (n = e[u++]) >> 2,
                            a = (3 & n) << 4 | (i = e[u++]) >> 4,
                            l = (15 & i) << 2 | (r = e[u++]) >> 6, s = 63 & r,
                            isNaN(i) ? l = s = 64 : isNaN(r) && (s = 64),
                            t = t + this.KEY_STR.charAt(o) +
                                this.KEY_STR.charAt(a) +
                                this.KEY_STR.charAt(l) + this.KEY_STR.charAt(s),
                            n = i = r = "", o = a = l = s = "", u < e.length;)
                     ;
                   return t
                 }
               },
               ...
               },
               {
                 ...
                 value : function(e, t) {
                   var n = e.replace("data:image/jpeg;base64,", ""),
                       i = this.decode64(n), r = i.indexOf(255, 3),
               ...
               },
               {
                 key : "decode64",
                 value : function(e) {
                   var t = void 0, n = void 0, i = "", r = void 0, o = void 0,
                       a = "", l = 0, s = [];
                   for (
                       /[^A-Za-z0-9\+\/\=]/g.exec(e) &&
                           console.warn(
  ...
  return d._autoDiscoverFunction = function() {
    ...
    if ("complete" !== o.readyState) {
      ...
      o[l](u + "DOMContentLoaded", i, !1), o[l](u + "readystatechange", i, !1),
          t[l](u + "load", i, !1)
    }
