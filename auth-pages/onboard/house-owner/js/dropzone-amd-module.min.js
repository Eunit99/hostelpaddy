!(function(e) {
    ...
    return (o(e,
      ...
      d = (function() {
        function z(e, t) {
          ...
          if (((n.options =
                    z.extend({}, n.defaultOptions, o, null != t ? t : {})),
                        ...
                        (this.prototype.defaultOptions = {
                          ...
                          addedfile : function(t) {
                            ...
                            if ((this.element === this.previewsContainer &&
                              ...
                              try {
                                for (var d,
                                     h = t.previewElement.querySelectorAll(
                              ...
                              try {
                                for (var y,
                                     g = t.previewElement.querySelectorAll(
                          ...
                          thumbnail : function(e, t) {
                            if (e.previewElement) {
                              ...
                              try {
                                for (var o,
                                     a = e.previewElement.querySelectorAll(
                                         "[data-dz-thumbnail]")
                                             [Symbol.iterator]();
                                     !(n = (o = a.next()).done); n = !0) {
                                  var l = o.value;
            ...
            o(z,
              [
                ...
                },
                {
                  ...
                  value : function() {
                    return this.files
                        .filter(function(e) { return !e.accepted; })
                        .map(function(e) { return e; });
                  },
                },
                {
                ...
                },
                {
                  key : "getQueuedFiles",
                  value :
                      function() { return this.getFilesWithStatus(z.QUEUED); },
                },
                {
                ...
                },
                {
                  key : "getAddedFiles",
                  value :
                      function() { return this.getFilesWithStatus(z.ADDED); },
                },
                {
                  key : "getActiveFiles",
                  value : function() {
                    ...
                    this.on(
                        ...
                        this.on("complete", function(e) {
                          if (0 === s.getAddedFiles().length &&
                            ...
                            return setTimeout(
                                function() { return s.emit("queuecomplete"); },
                                0);
                        });
                    function a(e) {
                      var t;
                            ...
                            events : {
                              click : function(e) {
                                return ((t === s.element &&
                                         e.target !== s.element &&
                                         !z.elementInside(
                                             e.target, s.element.querySelector(
                                                           ".dz-message"))) ||
                ...
                },
                {
                  ...
                  value : function(t, e, n, i, r) {
                    ...
                    if ((this.emit("addedfile", t), this.emit("complete", t),
                         a)) {
                      (t.dataURL = e),
                ...
                },
                {
                  ...
                  value : function(o, a, l, s, t, u, e) {
                    ...
                    return (
                        e && (d.crossOrigin = e), (d.onload = function() {
                          var e = function(e) { return e(1); };
                          return ("undefined" != typeof EXIF && null !== EXIF &&
                                      t &&
                                      (e =
                                           function(e) {
                                             return EXIF.getData(d, function() {
                                               return e(EXIF.getTag(
                                                   this, "Orientation"));
                                             });
                                           }),
                                  e(function(e) {
                                    (o.width = d.width), (o.height = d.height);
                                    var t = c.options.resize.call(c, o, a, l,
                                                                  s),
                ...
                },
                {
                  ...
                  value : function(t) {
                    return this.files
                        .filter(function(e) { return e.xhr === t; })
                        .map(function(e) { return e; });
                  },
                },
                {
                  ...
                  value : function(s) {
                    ...
                    this._transformFiles(s, function(e) {
                      if (u.options.chunking) {
                        var t = e[0];
                        (s[0].upload.chunked = u.options.chunking &&
                ...
                },
                {
                  ...
                  value : function(t, e) {
                    ...
                    i.open(u, c, !0),
                        ...
                        (i.onload = function(
                             e) { n._finishedUploading(t, i, e); }),
                        (i.ontimeout =
                             function() {
                               n._handleUploadError(
                                   t, i,
                                   "Request timedout after ".concat(
                                       n.options.timeout, " seconds"));
                             }),
                        (i.onerror =
                             function() { n._handleUploadError(t, i); }),
  ...
  d.initClass(), (d.version = "5.7.0"), (d.options = {}),
      (d.optionsForElement =
           function(e) {
             ...
             return (function() {
               ...
               try {
                 for (var r, o = s[Symbol.iterator]();
                      !(t = (r = o.next()).done); t = !0) {
                   var a = r.value;
                   !1 !== d.optionsForElement(a) ? e.push(new d(a))
                                                 : e.push(void 0);
                 }
               } catch (e) {
                 (n = !0), (i = e);
  ...
  (d.createElement =
      ...
      (d.isValidFile =
           function(e, t) {
             if (!t)
               return !0;
             t = t.split(",");
             var n = e.type, i = n.replace(/\/.*$/, ""), r = !0, o = !1,
                 a = void 0;
             try {
               for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done);
                 ...
                 if ("." === (u = u.trim()).charAt(0)) {
                   if (-1 !== e.name.toLowerCase().indexOf(
                                  u.toLowerCase(), e.name.length - u.length))
                     return !0;
                 } else if (/\/\*$/.test(u)) {
                   if (i === u.replace(/\/.*$/, ""))
                     return !0;
      ...
      (d.QUEUED = "queued"), (d.ACCEPTED = d.QUEUED),
      (d.UPLOADING = "uploading"), (d.PROCESSING = d.UPLOADING),
      (d.CANCELED = "canceled"), (d.ERROR = "error"), (d.SUCCESS = "success");
  ...
  v.initClass();
  return ((d._autoDiscoverFunction =
               function() {
                 if (d.autoDiscover)
                   return d.discover();
               }),
